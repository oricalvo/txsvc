...
TxSvc brings the power of Redux but with much less boilerplate. 
...
Other components can listen to the change event of the backing appStore by using any specific store
